...
import Jeremy from '../assets/images/image-jeremy-large.png'
    ...
    return(
        <div className="landing-page">
            ...
            <div className='header'>
                <img className='lineImage' src={Line}></img>
                <div className='header-title'>
                    <div className='header-title-line'>
                        <div className='header-title-unbold'>
                            A 
                        </div>
                ...
                <img className="phoneImage" src={PhoneImage}></img>
                <div className='header-numbers-section'>
                    <div className='header-numbers-section-part'>
            ...
            <div className='jeremy-content'>
                ...
                <div className='jeremy-text'>
                    <div className='jeremy-text-title'>
                        <div className='jeremy-text-title-unbold'>
                            It just
                        </div>
                        <div className='jeremy-text-title-bold'>
                            works.
                        </div>
                    </div>
                    <div className='jeremy-main-text'>
                        “I really like how it is an all-in-one solution that handle many of the tasks that you would normally 
                        need separate tools to do the same job. This thing is a miracle worker.”
                    </div>
                    <div className='jeremy-name'>
                        JEREMY ROBINSON
                    </div>
                    <div className='jeremy-footer'>
                        CMO, FYLO
                    </div>
                </div>
            </div>
